...
app.config[
    "MONGO_URI"] = 'mongodb+srv://alpha:root@cluster0.kdlhcph.mongodb.net/patient_database?retryWrites=true&w=majority'
    

mongo = PyMongo(app)  # connepipctor
